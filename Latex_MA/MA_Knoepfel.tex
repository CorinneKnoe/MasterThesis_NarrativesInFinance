...
('rate increases', 679),
('rate percent', 677),
('financial markets', 672),
('chief economist', 650),
('market committee', 633),
('quarter percentage', 619),
('basis point', 589),
('term interest', 578),
('rate increase', 573),
('fed officials', 569),
...
len(corpus.vocabulary)  = 23'313, initially there are 23'313 unique words in the text data, I remove all words that only occur once (7'906), twice (3396) or thrice (1867) // so in total I remove 13'169 tokens an the remaining 10'144 tokens are used for analysis
