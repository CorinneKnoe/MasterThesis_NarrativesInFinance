...
# =============================================================================
    ...
    for lamb in lamblist: #for every value of lambda print top ten words of all topics, and create graphs
        ...
        with open("C:/Users/corin/Documents/Uni/M.A.HSG/MA_Arbeit/MasterThesis_NarrativesInFinance/Code/Output/weights" + name + ".txt", "wb") as fp:
            pickle.dump(weights, fp)
        with open("C:/Users/corin/Documents/Uni/M.A.HSG/MA_Arbeit/MasterThesis_NarrativesInFinance/Code/Output/docweights" + name + ".txt", "wb") as fp:
            pickle.dump(docweights, fp)
...
################################## do it all over with a different level for classifying the policy days
        ...
        if any(adjustdfmod["Date"] != datelist):
            raise Exception("Topic classifications are nor allocated correctly to dates in dataframe -- order of days not correct!")
        adjustdfmod["Classification" + name] = ClasslistMod #add classificaton to data frame             
