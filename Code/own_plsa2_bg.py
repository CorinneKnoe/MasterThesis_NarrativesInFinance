...
if __name__ == "__main__":
    ...
    stoprule = 7500 #supposed to be 0.1
    
# =============================================================================
#     return_dict = {}
#     multiprocess_train(123, corpus, t_backg, lamb, number_of_topics, stoprule, return_dict)    
# =============================================================================
    ...
    final_dic = {}
    for lamb in [0.2,0.4,0.6]:
        
        manager = multiprocessing.Manager()
        return_dict = manager.dict()
        jobs = []
        #for lamb in [0.2, 0.4]:
        for i in range(3):#supposed to be 10: how often it is initialized with different values, i.e. how many processes run simultaneously
    ...
    for value in final_dic.values():
        print(final_dic.values())
    
# =============================================================================
#     path ="C:/Users/corin/Documents/Uni/M.A.HSG/MA_Arbeit/MasterThesis_NarrativesInFinance/Code/Output/top_words_plsa_backg.txt" #absolute path to where to store the txt files
...
#     adjustdf.to_csv("C:/Users/corin/Documents/Uni/M.A.HSG/MA_Arbeit/MasterThesis_NarrativesInFinance/Code/Output/AdjustmentsClassifiedPLSAbackg.csv", index=False, encoding="utf-8") #create a csv to store our data
#     
#     
...
#     plt.show()
#     fig.savefig("plsamodelling_backg.pdf", bbox_inches='tight')
#     
...
#     plt.show()    
#     f.savefig("docsplit01_backg.pdf", bbox_inches='tight')
#     
#     #plot of distribution over the documents per day
#     #second 28 days
#     f, axarr = plt.subplots(7, 4, figsize=(7,10))
...
#     plt.figlegend(handles=[topic1, topic2], loc = 'lower left', ncol=2, prop={'size': 10}, borderaxespad = 0, handletextpad = 0)
#     plt.show()  
#     f.savefig("docsplit02_backg.pdf", bbox_inches='tight')
# =============================================================================
