...
class Corpus(object):
	...
	def add_document(self, document): #add test to list of corpus
...
class Plsa(object):
	def __init__(self, corpus, number_of_topics, max_iter, model_path):
		...
		for di, doc in enumerate(corpus.documents): #give counter and value
			...
			for word in doc.words: #call list with clean words per document
			...
			self.n_w_d[di] = n_w_di #put it in matrix above
