...
if __name__ == "__main__":
    ...
    #==========================================
    textdf.to_csv("C:/Users/corin/Documents/Uni/M.A.HSG/MA_Arbeit/MasterThesis_NarrativesInFinance/FACTIVA_Data/TokenizedBigrams.csv", index=False, encoding="utf-8") #create a csv to store our data
